...
$\xi\in\R$ so $\xi$ is real number. Let $\alpha,\beta\ne0$ and are rational.
\begin{enumerate}
\item Proof : If $1 \text{ and } \xi$ are linearly independent, $\xi$ is irrational.

If $1 \text{ and } \xi$ are linearly independent,
suppose $\xi$ is not irrational. In other words, $\xi$ is rational.
When $\xi=-\dfrac{\alpha}{\beta}$, we have $\alpha\cdot1+\beta\cdot\xi=0$.
However, this is contradicted to the condition that $1 \text{ and } \xi$ are linearly independent. Therefore, if $1 \text{ and } \xi$ are linearly independent, $\xi$ is irrational.
\item Proof : If $\xi$ is irrational, $1 \text{ and } \xi$ are linearly independent.

If $\xi$ is irrational,
suppose $1 \text{ and } \xi$ are linearly dependent.
By it, for $\alpha,\beta$, we have $\alpha\cdot1+\beta\cdot\xi=0 \iff \xi=-\dfrac{\alpha}{\beta}$. This means $\xi$ is rational. However this is contradicted to the condition that $\xi$ is irrational. Therefore, if $\xi$ is irrational, $1 \text{ and } \xi$ are linearly independent.
\end{enumerate}
In conclusion, a necessary and sufficient condition that the vcectors 1 and $\xi$ in $\R$ be linearly independent is that the real number $\xi$ be irrational.
