...
For all $a,b,c,d \in \Q$, $\alpha_1 = a + b\sqrt2$ and $\alpha_2 = c + d\sqrt2$ holds.\\
...
\begin{enumerate}[label=\arabic*)]
\item
$\alpha_1 + \alpha_2 = \alpha_2 + \alpha_1$ (addition is commutative)
\item
$\alpha_1 + (\alpha_2 + \alpha_3) = (\alpha_1 + \alpha_2) + \alpha_3$ (addition is associative)
\item
We have $0 = 0 + 0\sqrt2 \in \Q(\sqrt2)$ and $\alpha_1 + 0 = \alpha_1$\\($\Q(\sqrt2)$ has additive identity)
\item
For all $a,b \in \Q$, put $\alpha_1 = a + b\sqrt2$. 
We have $-\alpha_1 = (-a) + (- b)\sqrt2$ and $(-a),(-b) \in \Q$. 
Terefore, to every $\alpha_1 \in \Q\sqrt2$, there corresponds $-\alpha_1 \in \Q\sqrt2$. 
Moreover, $\alpha_1 + (-\alpha_1) = 0$
\item
$\alpha_1\alpha_2 = \alpha_2\alpha_1$ (multiplication is commutative)
\item
$\alpha_1(\alpha_2\alpha_3) = (\alpha_1\alpha_2)\alpha_3$ (multiplication is associative)
\item
We have $1 = 1 + 0 \sqrt2 \in \Q(\sqrt2)$ and $\alpha_1 \cdot 1 = \alpha_1$\\
($\Q(\sqrt2)$ has multiplicative identity)
\item
For all $\alpha_1 \in \Q(\sqrt2)$ with $\alpha_1 \ne 0$, put $\alpha_1 = a + b\sqrt2$ with $a,b \in \Q$. In this case, $a \ne 0 \cap b \ne 0$ holds by the followings.\\
``If $\alpha_1 = 0$, we have $\alpha_1 = a + b\sqrt2 = 0 \Leftrightarrow a = -b\sqrt2$. 
Therefore, $a = b = 0$ by $a,b \in \Q$.''\\
Let $\alpha'_1 = \dfrac{1}{\alpha_1}$. $a - b\sqrt2 \ne 0$ holds by $a \ne 0 \cap b \ne 0$,
so we have $\alpha'_1 = \dfrac{1}{a + b\sqrt2} = \dfrac{a - b\sqrt2}{a^2 - 2b^2} = \dfrac{a}{a^2 - 2b^2} + \left(-\dfrac{b}{a^2 - 2b^2}\right)\sqrt2$.\\ In addition, we have $\dfrac{a}{a^2 - 2b^2}, -\dfrac{b}{a^2 - 2b^2} \in \Q$, so there exists $\alpha'_1 \in \Q(\sqrt2)$ with $\alpha_1\alpha'_1 = 1$
\item
$\alpha_1(\alpha_2 + \alpha_3) = \alpha_1\alpha_2 + \alpha_1\alpha_3$ (distributive law stands)
\end{enumerate}
