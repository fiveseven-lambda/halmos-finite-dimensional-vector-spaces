...
\begin{enumerate}[(a)]
  \item  Let $\alpha,\beta,\gamma \in \Zm$, $k \in \mathbb{Z}$\\
           \;Proof : if $m$ is a prime, $\Zm$ is a field.\\
...
\begin{enumerate}[1)]
  ...
  \item  if $\alpha + _\Z\beta = m$,
              $\alpha + \beta = (\alpha + _\Z\beta) \rem m = m \rem m = 0$ (there exists additive inverse)
  ...
  \item  $\alpha1 = (\alpha _\Z1)\rem m = \alpha \rem m = \alpha$ (there exists multiplicative identity)  By it and 5), if $\beta$ and $\gamma$ are multiplicative identity, $\beta = \beta\gamma = \gamma\beta = \gamma$ (multiplicative identity is unique)
  \item For all $\alpha (\alpha \neq 0)$, suppose there doesn't exist $\beta$ that makes $\alpha\beta = 1$.
           There exists $\alpha\beta = \alpha\gamma$ $(\beta \neq \gamma)$,
           because $\beta$ is any one from 0 to $m-1$ and $\alpha\beta$ is any one from 0 to $m-1$ except 1.
...
\end{enumerate}
           ...
           \;Proof : If $\Zm$ is a field, $m$ is a prime.\\
           ...
           If $m= 4$ and $\alpha = 2$, $\alpha0 = 0, \alpha1 = 2, \alpha2 = 0, \alpha3 = 2$,
           but it contradicts that there exists $\beta$ that makes $\alpha\beta = 1$.
           ...
           Therefore $\Zm$ is a field if and only if $m$ is a prime.
