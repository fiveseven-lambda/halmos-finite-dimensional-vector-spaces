...
Then, \begin{align*}
  ...
  &= \alpha_m(\overbrace{1 + \dotsb + 1}^\text{$(n-1)$ terms}) + \alpha_m && \text{(by distributive law)}\\
  &= \dotsb \\
  &= \alpha_m(1 + 1) + \overbrace{\alpha_m + \dotsb + \alpha_m}^\text{$(n-1)$ terms}\\
  &= \overbrace{\alpha_m + \dotsb + \alpha_m}^\text{$n$ terms} && \text{(by distributive law)} \\
