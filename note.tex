...
\item For every $(\alpha_1,\beta_1)$, there exists $(0,0) \in \F$ such that $(\alpha_1, \beta_1) + (0,0) = (\alpha_1, \beta_1)$.($\F$ has aditive identity)
...
\item For every $(\alpha_1,\beta_1)$, there exists $(1,0) \in \F$ such that $(\alpha_1,\beta_1)(1,0) = (\alpha_1,\beta_1)$.($\F$ has multiplicative identity)
...
For $\exists(\alpha, \beta)$, we have $(i,1)(\alpha, \beta) = (\alpha i -\beta, \beta i + \alpha) = (1,0)$. 
