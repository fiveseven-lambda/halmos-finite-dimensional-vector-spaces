...
and write $a \mid b$ if and only if $a \rem b = 0$.
For clarity,
...
Define $x_0, x_1, \ldots, \in \F$ as below:
\begin{align}
  x_0 &= 0, \\
  x_n &= x_{n - 1} + 1 \qquad (n > 0).
\end{align}
We have $x_m x_n = x_{mn}$ for all $m$ and $n$.
% ここに証明①
Assume there exists an $n$ with $x_n = 0$ but $x_k \ne 0$ for any $k < n$.
