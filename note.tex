...
Therefore, the number of  the vectors in this vector space is $p^2$.

\subsection{Exercise 2.3}
Suppose $\mathcal{V}$ is a vector space.
If $x = (0,1) \in \mathcal{V}$, we have $1(0,1) = (0,1)$ by definition of vector spaces, but we also have$1(0,1) = (0,0)$ by definition of $\mathcal{V}$. It is contradicted, so $\mathcal{V}$ is not a vector space.
