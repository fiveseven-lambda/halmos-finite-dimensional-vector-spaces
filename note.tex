...
\begin{enumerate}[label = (\alph*)]
\item
If the set of all polynomials with integer coeffficients form a field, polynomial $x (\ne 0)$ has multiplicative inverse. We have $x \cdot \frac{1}{x} = 1$, but $\frac{1}{x}$ is not a polynomial. Therefore, the set of all polynomials with integer coeffficients don't form a field.
\end{enumerate}
