...
\begin{itemize}
  ...
  \item[(e)]We have $(-1)\alpha = -(1\alpha)$ because multiplication is associative.
    We also obtain $-(1\alpha) = -(\alpha1)$ because multiplication is associative.
    The definition of multiplication leads $-(\alpha1) = -\alpha$,
    thus $(-1)\alpha = -\alpha$
