...
\item
 Let $\Z(\sqrt2)$ be the set of all numbers of the form $\alpha + \beta\sqrt2$, where $\alpha$ and $\beta$ are integers. If $\Z(\sqrt2)$ is a field, $2 = 2 + 0\sqrt2 (\in \Z(\sqrt2))$ have multiplicative inverse. We have $2 \cdot \frac{1}{2} = 1$, but $\frac{1}{2} \not\in \Z(\sqrt2)$. Therefore, $\Z(\sqrt2)$ is not a field.\\\\
